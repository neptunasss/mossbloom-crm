...
const CRM_CATEGORIES = [
  'Pardavimai', 'Žaliavos', 'Darbo užmokestis', 'Reklama',
  'Mokesčiai', 'Siuntimas', 'Paslaugos', 'Kitos išlaidos',
  'Nuoma', 'Transportas', 'Komisiniai', 'Kita',
];
...
const CATEGORY_MAP = {
  ...
  paslaugos: 'Paslaugos',
  services: 'Paslaugos',
  'b2b paslaugos': 'Paslaugos',
  'kitos išlaidos': 'Kitos išlaidos',
  'kitos islaidos': 'Kitos išlaidos',
  'kitos prekės': 'Kitos išlaidos',
  'kitos preke': 'Kitos išlaidos',
